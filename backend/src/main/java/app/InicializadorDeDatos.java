...
//      coleccionLucas.getFaltantes().add(griezmann);
...
//      coleccionSofia.getFaltantes().add(pedri);
...
//      coleccionMatias.getRepetidas().add(interMessi);
//      coleccionMatias.getRepetidas().add(interLautaro);

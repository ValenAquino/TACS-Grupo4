...
const UnoANSugerencias = () => {
    ...
    const cargarSugerencias = useCallback(async () => {
        try {
            setCargando(true)
            const payload = await buscarSugerencias({userId:1001, tipo: "1aN"})
    ...
    const mostrarSugerencias = () => {
        return (
            <>
                <ExtraInfo>
                    <p>Sugerencias de intercambio uno a muchos, podrias obtener mas de una figurita a cambio de una de las tuyas!</p>
                </ExtraInfo>
                {
...
export default UnoANSugerencias